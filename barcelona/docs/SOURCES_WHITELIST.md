# Whitelist sources (Barcelona)

As for Rome: prefer Commons; **`https://upload.wikimedia.org/...`**
is always allowed (see `barcelona/whitelist.py`).
...
| URL | Use |
|-----|-----|
| https://www.barcelona.cat/ | City administration |
