...
from french_architecture.data.style_catalog import STYLE_ORDER

_TEN_EXAMPLES = frozenset({"art_nouveau", "contemporary", "early_gothic", "haussmann", "louis_xiv_classicism", "modernism_lecorbusier"})
