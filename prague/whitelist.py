# -*- coding: utf-8 -*-
"""Image source URL checks against prague/docs/SOURCES_WHITELIST.md."""
...
def default_whitelist_path() -> Path:
    return _project_root() / "prague" / "docs" / "SOURCES_WHITELIST.md"
...
def url_is_whitelisted(
    ...
    *,
    ...
    if host in ("commons.wikimedia.org", "upload.wikimedia.org"):
        return True
    if host in ("en.wikipedia.org", "en.m.wikipedia.org", "cs.wikipedia.org"):
