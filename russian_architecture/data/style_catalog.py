...
STYLE_EXAMPLES: dict[str, list[dict[str, Any]]] = {
    "ancient_rus": [
        ...
        _ex(
            ...
            city_ru="Киев",
            city_en="Kyiv",
            history_ru="Заложен Ярославом Мудрым; сохранились мозаики "
            "и фрески XI века.",
            history_en="Founded by Yaroslav the Wise; eleventh-century "
            "mosaics and frescoes survive.",
            significance_ru="Главный храм Киевской Руси и объект "
            "Всемирного наследия ЮНЕСКО.",
            significance_en="Principal church of Kyivan Rus and a UNESCO "
            "World Heritage site.",
            commons_url=(
                "https://upload.wikimedia.org/wikipedia/commons/a/a9/"
                "80-391-9014_Kyiv_Sofia_2_RB_24.jpg"
            ),
        ),
    ],
    "novgorod_school": [
