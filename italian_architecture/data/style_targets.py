...
from italian_architecture.data.style_catalog import STYLE_ORDER

_TEN_EXAMPLES = frozenset({"baroque", "contemporary", "early_renaissance", "high_renaissance", "liberty"})
