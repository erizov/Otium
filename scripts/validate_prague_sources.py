# -*- coding: utf-8 -*-
"""Validate Prague image_source_url entries against the whitelist."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Validate Prague place image_source_url against "
    ...
    if errors:
        print("Prague source URL validation failed:", file=sys.stderr)
        for line in errors:
