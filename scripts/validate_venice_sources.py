# -*- coding: utf-8 -*-
"""Validate Venice image_source_url entries against the whitelist."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Validate Venice place image_source_url against "
    ...
    if errors:
        print("Venice source URL validation failed:", file=sys.stderr)
        for line in errors:
