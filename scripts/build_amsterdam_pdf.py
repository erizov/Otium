...
_TITLE_SYMBOLS = title_symbols_for_slug("amsterdam")
...
def main() -> int:
    return run_build_pdf_main(
        ...
        city_slug="amsterdam",
        city_root=_PROJECT_ROOT / "amsterdam",
        display_title="Amsterdam",
        title_symbols_class="amsterdam-title-symbols",
        title_symbols=_TITLE_SYMBOLS,
        places=list(AMSTERDAM_PLACES),
        html_name="amsterdam_guide.html",
        pdf_name="amsterdam_guide.pdf",
        argv=sys.argv[1:],
    )
