...
from vologda.whitelist import default_whitelist_path
from vologda.whitelist import url_is_whitelisted
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Download Vologda guide images.",
    )
    parser.add_argument(
        "--vologda-root",
        type=Path,
        default=_PROJECT_ROOT / "vologda",
        dest="city_root",
        help="vologda tree root",
    )
