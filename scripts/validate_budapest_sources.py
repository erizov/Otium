# -*- coding: utf-8 -*-
"""Validate Budapest image_source_url entries against the whitelist."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Validate Budapest place image_source_url against "
    ...
    if errors:
        print("Budapest source URL validation failed:", file=sys.stderr)
        for line in errors:
