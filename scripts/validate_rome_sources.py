# -*- coding: utf-8 -*-
"""Validate Rome image_source_url entries against the whitelist."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Validate Rome place image_source_url against "
    ...
    if errors:
        print("Rome source URL validation failed:", file=sys.stderr)
        for line in errors:
