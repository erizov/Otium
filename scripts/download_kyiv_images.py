...
from kyiv.whitelist import default_whitelist_path
from kyiv.whitelist import url_is_whitelisted
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Download Kyiv guide images.",
    )
    parser.add_argument(
        "--kyiv-root",
        type=Path,
        default=_PROJECT_ROOT / "kyiv",
        dest="city_root",
        help="kyiv tree root",
    )
    ...
    return download_jerusalem_style_images(
        ...
        title_page_assets=title_page_assets_for_download_arg("kyiv"),
        args=args,
