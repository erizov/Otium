# -*- coding: utf-8 -*-
"""Validate Montreal image_source_url entries against the whitelist."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Validate Montreal place image_source_url against "
    ...
    if errors:
        print("Montreal source URL validation failed:", file=sys.stderr)
        for line in errors:
