# -*- coding: utf-8 -*-
"""Validate Vienna image_source_url entries against the whitelist."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Validate Vienna place image_source_url against "
    ...
    if errors:
        print("Vienna source URL validation failed:", file=sys.stderr)
        for line in errors:
