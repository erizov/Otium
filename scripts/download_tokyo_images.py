...
from tokyo.whitelist import default_whitelist_path
from tokyo.whitelist import url_is_whitelisted
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Download tokyo guide images.",
    )
    parser.add_argument(
        "--tokyo-root",
        type=Path,
        default=_PROJECT_ROOT / "tokyo",
        dest="city_root",
        help="tokyo tree root",
    )
    ...
    return download_jerusalem_style_images(
        ...
        title_page_assets=title_page_assets_for_download_arg("tokyo"),
        args=args,
