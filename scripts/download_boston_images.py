# -*- coding: utf-8 -*-
"""Download Boston guide images from image_source_url (flat images/)."""
...
_USER_AGENT = (
    "ExcursionGuide-Boston/1.0 (batch download for local guide; "
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Download Boston guide images into boston/images/.",
    )
    parser.add_argument(
        "--boston-root",
        type=Path,
    ...
    if not todo:
        ...
        if n == 0:
            print(
                "No entries in BOSTON_PLACES — add boston_places.json.",
                file=sys.stderr,
            )
