# -*- coding: utf-8 -*-
"""Download Vienna guide images from image_source_url (flat images/)."""
...
from vienna.data.places_registry import VIENNA_PLACES
from vienna.whitelist import default_whitelist_path, url_is_whitelisted
...
_TITLE_PAGE_ASSETS: tuple[tuple[str, str], ...] = (
    ...
    (
        ...
        "Flag_of_Vienna_%28state%29.svg",
    ),
)
_USER_AGENT = (
    "ExcursionGuide-Vienna/1.0 (batch download for local guide; "
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Download Vienna guide images into vienna/images/.",
    )
    parser.add_argument(
        "--vienna-root",
        type=Path,
    ...
    if not todo:
        ...
        if n == 0:
            print(
                "No entries in VIENNA_PLACES — add vienna_places.json.",
                file=sys.stderr,
            )
