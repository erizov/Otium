# -*- coding: utf-8 -*-
"""Download istanbul guide images."""
...
from istanbul.data.places_registry import ISTANBUL_PLACES
from istanbul.whitelist import default_whitelist_path
from istanbul.whitelist import url_is_whitelisted
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Download istanbul guide images.",
    )
    parser.add_argument(
        "--istanbul-root",
        type=Path,
        default=_PROJECT_ROOT / "istanbul",
        dest="city_root",
        help="istanbul tree root",
    )
    ...
    return download_jerusalem_style_images(
        ...
        title_page_assets=title_page_assets_for_download_arg("istanbul"),
        args=args,
