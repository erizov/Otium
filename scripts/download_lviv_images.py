...
from lviv.data.places_registry import LVIV_PLACES
from lviv.whitelist import default_whitelist_path
from lviv.whitelist import url_is_whitelisted
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Download Lviv guide images.",
    )
    parser.add_argument(
        "--lviv-root",
        type=Path,
        default=_PROJECT_ROOT / "lviv",
        dest="city_root",
        help="lviv tree root",
    )
    ...
    return download_jerusalem_style_images(
        ...
        title_page_assets=title_page_assets_for_download_arg("lviv"),
        args=args,
