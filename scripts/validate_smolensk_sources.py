# -*- coding: utf-8 -*-
"""Проверка image_source_url у объектов Смоленска против whitelist."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Validate Smolensk place image_source_url against "
    ...
    if errors:
        print("Smolensk source URL validation failed:", file=sys.stderr)
        for line in errors:
