...
_TITLE_SYMBOLS = title_symbols_for_slug("london")
...
def main() -> int:
    return run_build_pdf_main(
        ...
        city_slug="london",
        city_root=_PROJECT_ROOT / "london",
        display_title="London",
        title_symbols_class="london-title-symbols",
        title_symbols=_TITLE_SYMBOLS,
        places=list(LONDON_PLACES),
        html_name="london_guide.html",
        pdf_name="london_guide.pdf",
        argv=sys.argv[1:],
    )
