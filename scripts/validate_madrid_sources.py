# -*- coding: utf-8 -*-
"""Validate Madrid image_source_url entries against the whitelist."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Validate Madrid place image_source_url against "
    ...
    if errors:
        print("Madrid source URL validation failed:", file=sys.stderr)
        for line in errors:
