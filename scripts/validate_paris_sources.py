# -*- coding: utf-8 -*-
"""Validate Paris image_source_url entries against the whitelist."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Validate Paris place image_source_url against "
    ...
    if errors:
        print("Paris source URL validation failed:", file=sys.stderr)
        for line in errors:
