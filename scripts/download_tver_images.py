...
from tver.whitelist import default_whitelist_path
from tver.whitelist import url_is_whitelisted
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Download Tver guide images.",
    )
    parser.add_argument(
        "--tver-root",
        type=Path,
        default=_PROJECT_ROOT / "tver",
        dest="city_root",
        help="tver tree root",
    )
    ...
    return download_jerusalem_style_images(
        ...
        title_page_assets=title_page_assets_for_download_arg("tver"),
        args=args,
