...
_TITLE_SYMBOLS = title_symbols_for_slug("volgograd")
...
def main() -> int:
    return run_build_pdf_main(
        ...
        city_slug="volgograd",
        city_root=_PROJECT_ROOT / "volgograd",
        display_title="Volgograd",
        title_symbols_class="volgograd-title-symbols",
        title_symbols=_TITLE_SYMBOLS,
        places=list(VOLGOGRAD_PLACES),
        html_name="volgograd_guide.html",
        pdf_name="volgograd_guide.pdf",
        argv=sys.argv[1:],
    )
