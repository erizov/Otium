# -*- coding: utf-8 -*-
"""Validate Berlin image_source_url entries against the whitelist."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Validate Berlin place image_source_url against "
    ...
    if errors:
        print("Berlin source URL validation failed:", file=sys.stderr)
        for line in errors:
