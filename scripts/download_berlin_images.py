# -*- coding: utf-8 -*-
"""Download Berlin guide images from image_source_url (flat images/)."""
...
from berlin.whitelist import default_whitelist_path, url_is_whitelisted
...
_USER_AGENT = (
    "ExcursionGuide-Berlin/1.0 (batch download for local guide; "
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Download Berlin guide images into berlin/images/.",
    )
    parser.add_argument(
        "--berlin-root",
        type=Path,
    ...
    if not todo:
        ...
        if n == 0:
            print(
                "No entries in BERLIN_PLACES — add berlin_places.json.",
                file=sys.stderr,
            )
