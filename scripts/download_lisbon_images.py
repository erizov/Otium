...
from lisbon.data.places_registry import LISBON_PLACES
from lisbon.whitelist import default_whitelist_path
from lisbon.whitelist import url_is_whitelisted
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Download lisbon guide images.",
    )
    parser.add_argument(
        "--lisbon-root",
        type=Path,
        default=_PROJECT_ROOT / "lisbon",
        dest="city_root",
        help="lisbon tree root",
    )
    ...
    return download_jerusalem_style_images(
        ...
        title_page_assets=title_page_assets_for_download_arg("lisbon"),
        args=args,
