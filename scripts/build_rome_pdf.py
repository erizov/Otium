...
_TITLE_SYMBOLS = title_symbols_for_slug("rome")
...
def main() -> int:
    ...
    return run_build_pdf_main(
        ...
        city_slug="rome",
        city_root=_PROJECT_ROOT / "rome",
        display_title="Rome",
        title_symbols_class="rome-title-symbols",
        title_symbols=_TITLE_SYMBOLS,
        places=list(ROME_PLACES),
        html_name="rome_guide.html",
        pdf_name="rome_guide.pdf",
        argv=sys.argv[1:],
    )
