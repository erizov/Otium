...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Download dubai guide images.",
    )
    parser.add_argument(
        "--dubai-root",
        type=Path,
        default=_PROJECT_ROOT / "dubai",
        dest="city_root",
        help="dubai tree root",
    )
    ...
    return download_jerusalem_style_images(
        ...
        title_page_assets=title_page_assets_for_download_arg("dubai"),
        args=args,
