# -*- coding: utf-8 -*-
"""Validate Florence image_source_url entries against the whitelist."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Validate Florence place image_source_url against "
    ...
    if errors:
        print("Florence source URL validation failed:", file=sys.stderr)
        for line in errors:
